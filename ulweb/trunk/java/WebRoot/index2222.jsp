...
<td><a href="list.jsp?id=3105" target="_blank"><img id="tag_mgzz1" src="images/bobao.jpg" class="tagSel" onmouseover="tagSelect('mgzz', 1, 2)" /></a></td>
<td></td>
<td><a href="list.jsp?id=3104" target="_blank"><img id="tag_mgzz2" src="images/meiti.jpg" class="tag" onmouseover="tagSelect('mgzz', 2, 2)" /></a></td>
</tr></table>
</p>
</div>
<div class="za">
...
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="wzbb" pageNum="1" pageSize="4" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
...
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="wzbb" pageNum="2" pageSize="4" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
<li><span class="fri"><bean:write name="element" property="uploadTime" format="yyyy-MM-dd" /></span>·<a href="show.do?c=<bean:write name="element" property="contentId" />" target="_blank" title="<bean:write name="element" property="contentName" />" <logic:equal name="element" property="displayType" value="9">style="color:#ff0000"</logic:equal> ><script>document.writeln("<bean:write name="element" property="contentName" />".substring(0,28));</script></a></li>
		</logic:iterate>
</ul>
...
<div class="Hnav"><span class="fri"><a href="list.jsp?id=8" target="_blank"><img src="images/mor1.jpg" /></a></span><img src="images/tushuo1.jpg"  /></div>
<div class="Hcon">
...
<div class="xt">
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="2" pageSize="12" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li>·<a href="<bean:write name="element" property="subTitle" />" target="_blank"><bean:write name="element" property="contentName" /></a></li>
		</logic:iterate>
...
<% index1++; %>
							...
							<script language="javascript" src="js/newsAd3.js"></script>
								<table id=newsTable1 border="0" cellspacing="0" cellpadding="0" style="border: solid 1px #CCCCCC; ">
									...
									<tr>
										<td><img src="images/gongyi1.jpg" /><a href="list.jsp?id=3048" target="_blank"><img src="images/mor.jpg" width="50" height="28" /></a>
											<a
...
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="lianghui" pageNum="1" pageSize="4" withAtt="1" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
		 <logic:notEmpty name="element" property="attachmentList">
		  <logic:iterate id="e" name="element" property="attachmentList">
