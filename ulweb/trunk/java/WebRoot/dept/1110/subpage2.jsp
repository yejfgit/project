...
<table width="770" cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#ffffff" >
		...
		<tr><td height="3" ></td></tr>	
		<tr><td height="3" style="border-top:1px #dddddd solid;">
		<table cellpadding="0" cellspacing="0" height="1"><tr><td></td></tr></table>
		</td></tr>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" id="mainContent"> 
					<tr>
						...
						<td align="center"  width="150" valign="top" s>
							<table  width="100" cellpadding="5" cellspacing="5" border="0" class="list1">
								<tr><td height="20" style="background-image:none;"></td></tr>
								<tr>
									<td align="center" background="<%=t.getPic2()%>">
								...
								<tr><td height="20"  style="background-image:none;"></td></tr>
								<tr><td  style="background-image:none;" align="center">
						...
						<td  valign="top">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td height="30" >
										<table cellpadding="5" width="100%"  cellspacing="4" border="0" class="list2">
											<tr>
												<%
													for(int i = 0 ; i < (list2 == null ? 0 : list2.size()); i++){
												%>
												
												<td width="80" align="center" background="<%
