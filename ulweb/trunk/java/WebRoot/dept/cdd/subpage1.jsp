	 ...
	 文件查询
	  ...
	  <div id="advert" >
		...
		<div style="padding:15px 0px 0px 25px;">
		  ...
		  <br>
			&nbsp;&nbsp;&nbsp;至：<input id="demo1" name="td" size="18" value="" type="text" style="text-align:right;" />			
			<br>
			<center>
...
<div id="contentsub1">
  <div class="feature">
  	<div class="titlecenter1" style="background-image:url('images/cdd/smalltitle.gif'); padding:8px 0px 0px 25px;">
		<%=c.getColumnName()%>
	</div>
  	<div style="height:410px;overflow:visible;padding:15px 5px 5px 20px;">
