...
<%@ page language="java" import="java.util.*,com.ulic.ulweb.ulweb2.entity.ContentEntity,com.ulic.ulweb.ulweb.entity.UlAttachment,com.ulic.ulweb.frame.constant.Constant,com.ulic.ulweb.ulweb.entity.UlColumn" pageEncoding="UTF-8"%>
<%
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td rowspan="3" align="center" valign="top">
        			<div style=" margin: 0px 0px 0px 30px; padding: 13px 2px 7px 58px; width: 582px; height: 22px; background-image: url('images/budongchan/listtitlebgsub.jpg')"><span class="listtitle1"><%=column.getColumnName()%></span></div>
					<div>&nbsp;</div>
	<%
