...
function dakularButtons(){if(buttonShow==1){
	...
	switch(buttonPos){
		case 1:{buttonX=480-imgUrl.length*20;buttonY=16;break;}
		case 2:{buttonX=680-imgUrl.length*20;buttonY=200;break;}
		case 3:{buttonX=imgUrl.length*20-100;buttonY=16;break;}
		case 4:{buttonX=imgUrl.length*20-100;buttonY=200;break;}
		default:{buttonX=480-imgUrl.length*20;buttonY=16;break;}
	}

	for(i=1;i<=imgUrl.length-1;i++){
		dakularCode=dakularCode+"<div id='bt"+i+"' style='display:inline; height=24px; width:20px; border:1px solid #000000; background-color:#CCCCCC; color:#000000; font-size:12px; line-height:14px; filter: Alpha(Opacity=100);' align='center' onMouseOver=this.style.backgroundColor='#FFFFFF';this.style.color='#000000';this.style.cursor='hand' onMouseOut=checkButton(); onClick='clearTimeout(theTimer);nextAd("+i+");'>&nbsp;"+i+"&nbsp;</div>";
	}
