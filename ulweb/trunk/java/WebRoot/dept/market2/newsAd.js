...
function dakularButtons(){if(buttonShow==1){
	...
	switch(buttonPos){
		case 1:{buttonX=175-imgUrl.length*20;buttonY=16;break;}
		case 2:{buttonX=260-imgUrl.length*20;buttonY=170;break;}
		case 3:{buttonX=imgUrl.length*20-100;buttonY=16;break;}
		case 4:{buttonX=imgUrl.length*20-100;buttonY=170;break;}
		default:{buttonX=175-imgUrl.length*20;buttonY=16;break;}
	}
	...
	dakularCode="<div style='display:inline; position:relative;left:260px; top:215px; z-index:1;'>"+dakularCode+"</div>"
