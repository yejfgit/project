      ...
      <tr>
        <td width="20%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			%>
			<div style="width:100%">
			<div class="navleft_col">
				<strong><%=c.getParentName()!=null?c.getParentName():""%></strong>
			</div>
			<div class="navleft_col">
				<div style="margin-left:10px"><%=c.getParentName()!=null?d.divColumn("columnList", "shichang.do?method=subPage1&", 0):""%></div>
			</div>
			</div>
...
<% }else {%>
        ...
        <td width="60%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<!-- body center div -->
				<div class="body_nav">
					<div class="body_nav_text"><a href="shichang.do?method=index" class="body_nav_text">首页</a>&nbsp;&gt;&gt;&nbsp;<%=c.getParentName()!=null?c.getParentName():c.getColumnName()%><%=c.getParentName()!=null?"&nbsp;&gt;&gt;&nbsp;"+c.getColumnName():""%></div>
				</div>
				
				<div class="bodycontent_list">
					<%=d.divContent("contentList",3)%>
					<div class="navleft_col"><%=request.getAttribute("subcolumnList")!=null?d.divColumn("subcolumnList", "shichang.do?method=subPage1&", 0):""%></div>
				</div>
