   ...
   <div class="relatedLinks">
	...
	<%
		...
		for(int i = 0 ; i < (cList == null ? 0 : cList.size()); i++){
			...
			out.print(cList.get(i).getColumnName());			
			if(i < 4)out.print("<img src='images/index/new_01.gif' border='0' />");
			out.print("</a></li>");
		}  
	%> 
...
<script language="javascript">
//	window.open("show.do?ptype=edm&c=4934","deptmessage","width=300,height=360,scrollbars=no,resizable=no,top=200,left=100,toolbar=no");
</script>
</body>
</HTML>