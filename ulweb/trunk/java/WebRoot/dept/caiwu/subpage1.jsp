    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td rowspan="3" valign="top">
			<div style=" margin: 0px 0px 0px 30px; padding: 13px 2px 7px 58px; width: 582px; height: 22px; background-image: url('images/caiwu/listtitlebgsub.jpg')"><span class="listtitle1"><%=c.getColumnName()%></span></div>
		
			<div style=" margin: 10px 30px 10px 30px; padding:10px 0px 10px 10px; height:500px;" class="listcontentsub">
				<%=d.divContent("contentList",3).replace("<p>", "<p><img src=\"images/caiwu/dot.gif\" border=\"0\">&nbsp;")%>
			</div>
