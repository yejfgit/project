...
<div id="main">
   ...
   <div id="collist">
   <div id="collist_head" class="col_title"><a href="dangjian.do?method=index">党建网</a>>>书法
   </div>
  <div id="box1">
<ul>
  ...
  <%int i = 0; %>
		<logic:iterate id="element" name="cl" property="objectList">
		   <logic:notEmpty name="element" property="attachmentList">
			...
			<%i++; %>
			 <p align="center"><a href="<bean:write name="e" property="displayPath" />" target="_blank"><img src="<bean:write name="e" property="displayPath" />" width="200" height="150" class="bor"/></a></p>
