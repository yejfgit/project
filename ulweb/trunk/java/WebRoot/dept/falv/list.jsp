...
<title>法律合规部 - <%=d.getColumn().getColumnName() %></title>
	...
	<div id="body">
		...
		<div class="container">
			...
			<div class="col_content">
				<ul>
					<%=d.showContentList("contentList", 30, "falv.do?method=detail&")%>												
				</ul>	
		...
		<div id="grp_right">
			...
			<% if (request.getAttribute("parentName") != null) { %>
			<div class="col_small">
				<div class="col_title">			
					<h1><%=request.getAttribute("parentName") %></h1>
				</div>
				
				<div class="col_content">
					<ul>
						<%=d.showColumnList("columnList", 15, "falv.do?method=list") %>
					</ul>	
				</div>	
