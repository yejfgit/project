									...
									<tr><td align="center">
										<table cellpadding="0" cellspacing="0" border="0" width="200" align="center">
											...
											<tr style="border-bottom:1px gray solid;">
												<td align="center">													
													<a href="list.do?method=zongbu&ptype=<%=request.getAttribute("ptype")%>&columnId=<%=listc.get(i).getColumnId()%>" ><%=listc.get(i).getColumnName()%></a>
												</td>
											</tr>
							  ...
							  <td valign="top">
							  		<table border="0" width="100%" >
										...
										<%
											...
											%>
											<tr>
											<form action="oldFile.do?method=list&sp=/subpage/o1t4.jsp" method="post" name="forms" id="idforms">
