							  		...
							  		<table border="0" width="100%" align="left">
										...
										<tr>
											<td align="right"  colspan="5">
												<a href="files/0000/2007/5/11/302366535.doc" style="color:red;" target="_blank">关于明确《合众人寿保险股份有限公司内部风险控制》手册使用规范的通知</a>
											</td>
										</tr>
										<tr><td colspan="5" align="right">共享用户：pdfshare  &nbsp;&nbsp;&nbsp;密码：pdfshare &nbsp;&nbsp;&nbsp;
											<br />
												pdf阅读器下载:<a href="tools/itresource/AdbeRdr70_enu.rar" target="_blank" class=9b>Acrobat Reader7.0 安装软件</a></td>
										</tr>
												...
												if(list != null){
													for(int i = 0; i < list.size(); i++){					
														...
														if(list.get(i).getHaveContent() == 0 && list.get(i).getAttachmentSum() != 0){
															...
															out.println(list.get(i).getContentName() + "&nbsp;/" + list.get(i).getUpdateTime().toString().substring(0,list.get(i).getUpdateTime().toString().indexOf(" ")) + "</a>");					
