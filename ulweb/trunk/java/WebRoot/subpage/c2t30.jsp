											...
											<tr>												
              							        <td>
													<table border="0" width="100%" cellspacing="0">														
														...
														<tr><td align="center">
			<a href="list.do?method=zongbu&scid=908&ptype=31&columnId=907" style="font-size:14px;">客服活动概述</a>
														</td></tr>
														...
														<tr>
															<td  align="center">
																<a style="font-size:14px;" href="list.do?method=zongbu&scid=<%=cl.get(i).getColumnId()%>&ptype=<%=ptype%>&columnId=<%=cp.getColumnId()%>" >
																<%
