					...
					<table width="100%" style="border-right: gray 1px solid;">
                      ...
                      <td>
					  	<table border="0" align="center" width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=2&keyword=1&sp=/subpage/o2t9.jsp" <%=(((String)request.getAttribute("keywordName")).equals("合保人") ? "style=\"color:blue;\"" : "")%> >合保人</a>
															</td>
														</tr>
														<tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=2&keyword=2&sp=/subpage/o2t9.jsp" <%=(((String)request.getAttribute("keywordName")).equals("合保发") ? "style=\"color:blue;\"" : "")%>>合保发</a>
															</td>
														</tr><tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=2&keyword=3&sp=/subpage/o2t9.jsp"  <%=(((String)request.getAttribute("keywordName")).equals("合保复") ? "style=\"color:blue;\"" : "")%>>合保复</a>
															</td>
														</tr><tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=2&keyword=4&sp=/subpage/o2t9.jsp" <%=(((String)request.getAttribute("keywordName")).equals("合保办") ? "style=\"color:blue;\"" : "")%> >合保办</a>
															</td>
														</tr>
														<tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=2&keyword=5&sp=/subpage/o2t9.jsp"  <%=(((String)request.getAttribute("keywordName")).equals("合保会纪") ? "style=\"color:blue;\"" : "")%>>合保会纪</a>
															</td>
														</tr>
						</table>
					  </td>
                      ...
                      <td width="70%" align="center"> <font color="#FF3333" style="font-size:20px"><strong> 
                        <%=request.getAttribute("keywordName")%>
                        </strong> </font> </td>
														<td  align="center">
															<a href="list.do?method=zongbu&ptype=9&columnId=<%=Constant.gongwen%>" >2007年4月以后的数据</a>
														</td>
													</tr>
												</table>
											</td>
										...
										<%
											...
											%>
											<tr>
											<form action="oldFile.do?method=list&sp=/subpage/o2t9.jsp" method="post" name="forms" id="idforms">
