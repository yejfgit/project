										 ...
										 int isTop = 30751;
												...
												//
													...
													for(int i = 0; i < list.size(); i++){
														...
														if (list.get(i).getContentId() != isTop) {
															continue;
														}
														...
														if(list.get(i).getHaveContent() == 0 && list.get(i).getAttachmentSum() != 0){
															out.print("<a target='_blank' href='show.do?c=" + list.get(i).getContentId() + "&a=1' style='color:#FF0000'>");
															...
															if(list.get(i).getAttachmentSum() > 1){
																...
																for(int j = 2; j <= list.get(i).getAttachmentSum() ; j++){
																	out.print("<a target='_blank' href='show.do?c=" + list.get(i).getContentId() + "&a=" + j + "' style='color:#FF0000'>");
																	out.print("附件" + (j - 1) + "</a> &nbsp;&nbsp;");
																}
																//out.print("</td><td></td></tr>");
															}
														}else{
															out.print("<a target='_blank' href='showDocument.do?c=" + list.get(i).getContentId() + "' style='color:#FF0000'>");
															out.println(list.get(i).getContentName() + "&nbsp;/" + list.get(i).getUploadTime().toString().substring(0,list.get(i).getUploadTime().toString().indexOf(" ")) + "</a>");					
