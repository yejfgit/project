				...
				<table width=100% cellPadding=0 
                  cellSpacing=0 bgcolor="#FFFFFF"   >
						...
						<tr> 
						  ...
						  <td rowspan="4" valign="middle" width="639" background="images/index/zhixing.jpg" style="background-repeat:no-repeat;"><div style="width:100%;text-align:center;font-size:24px;font-family:'黑体';font-style:italic;font-weight:bold;color:#ffffff;">
			我的执行，我的责任       ----2009合众执行年
		</div></td>
						</tr>
						<tr> 
						...
						<tr>
											...
											<tr>												
              							        <td>
													<table border="0" width="100%" cellspacing="0">														
														...
														<tr>
															<td  align="center">
																<a style="font-size:14px;line-height:20px;" href="list.do?method=zongbu&scid=<%=cl.get(i).getColumnId()%>&ptype=<%=ptype%>&columnId=<%=cp.getColumnId()%>" >
																<%
							if(cl.get(i).getColumnId() == c.getColumnId()){
								...
								out.print(cl.get(i).getColumnName());
									...
									<tr><td></td></tr>
									<tr valign="bottom"><td height="200"></td></tr>
