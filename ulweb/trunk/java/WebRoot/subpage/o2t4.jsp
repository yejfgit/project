				...
				<table width=100% cellPadding=0 
                  cellSpacing=0 bgcolor="#FFFFFF"   >
						...
						<tr> 
						  ...
						  <td rowspan="4" valign="top" width="639" background="images/index/baozhi.jpg" style="background-repeat:no-repeat;"></td>
						</tr>
						<tr> 
						  <td height="1"></td>
						  <td></td>
			...
			<td >
					<table width="100%" style="border-right: gray 1px solid;">
						...
						<tr>
							...
							<tr>
															<td align="center" >
																<a href="oldFile.do?method=list&columnId=70&sp=/subpage/o2t4.jsp" >合众简报</a>
															</td>
														</tr>
														<tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=73&sp=/subpage/o2t4.jsp">行业资讯</a>
															</td>
														</tr><tr>
															<td align="center">
																<a href="oldFile.do?method=list&columnId=71&sp=/subpage/o2t4.jsp" >机构发展快讯</a>
															</td>
														</tr>
						</table>
									...
									<tr valign="bottom"><td align="center">
										<img src="images/index/xiezuo.jpg" border="0" width="220" /></td></tr>
									<tr><td height="10"></td></tr>
									<tr valign="bottom">
								<td align="center" >&nbsp; </td>
							  </tr>
							  		...
							  		<table border="0" width="100%" >
										<tr>
											<td colspan="5" align="center">
												...
												<%	
													int newColumnId = Constant.hezhongjianbao;
												...
												%></strong>
														...
														<td  align="center">
															<a href="list.do?method=zongbu&ptype=4&columnId=<%=Constant.xinxikuaidi%>&scid=<%=newColumnId%>" >2007年4月以后的数据</a>
														</td>
													</tr>
												</table>
											</td>
										...
										<%
											...
											%>
											<tr>
											<form action="oldFile.do?method=list&sp=/subpage/o2t4.jsp" method="post" name="forms" id="idforms">
