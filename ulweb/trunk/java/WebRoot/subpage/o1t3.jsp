...
<html>
  ...
  <script  language="JavaScript" src="script/oldFileOther.js"></script>
  <body>
							  ...
							  <td valign="top">
							  		<table border="0" width="100%" >
										<tr>
											<td colspan="5" align="center">
												...
												%></strong>
														...
														<td  align="center">
															<a href="list.do?method=zongbu&ptype=3&columnId=<%=newColumnId%>" >2007年4月以后的数据</a>
														</td>
													</tr>
												</table>
										...
										<%
											...
											%>
											<tr>
											<form action="oldFile.do?method=list&sp=/subpage/o1t3.jsp" method="post" name="forms" id="idforms">
