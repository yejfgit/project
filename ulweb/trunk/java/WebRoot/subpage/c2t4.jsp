...
<%@ page language="java" import="java.util.*,com.ulic.ulweb.ulweb.entity.UlContent,com.ulic.ulweb.ulweb.entity.UlColumn,com.ulic.ulweb.frame.constant.Constant" pageEncoding="UTF-8"%>
<%
													...
													<table border="0" width="100%" cellpadding="3" cellspacing="0">														
														<tr>
															<td align="center" style="border-bottom: 1px gray solid;"  >
																<font color="#FF6600" style="font-size:16px"><%=(cp == null ? "" : cp.getColumnName())%></font>
															</td>
														</tr>
														<%
														...
														<tr>
															<td  align="center">
																<a href="list.do?method=zongbu&scid=<%=cl.get(i).getColumnId()%>&ptype=<%=ptype%>&columnId=<%=cp.getColumnId()%>" >
																<%
