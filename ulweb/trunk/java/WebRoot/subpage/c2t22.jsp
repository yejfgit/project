				...
				<table width=100% cellPadding=0 
                  cellSpacing=0 bgcolor="#FFFFFF"   >
						...
						<tr> 
						  ...
						  <td rowspan="4" valign="top" width="639" background="images/index/080922fuwunian1.jpg" style="background-repeat:no-repeat;"></td>
						</tr>
						<tr> 
						  <td height="1"></td>
						  <td></td>
							...
							if(cl.get(i).getColumnId() == c.getColumnId()){
								...
								out.print(cl.get(i).getColumnName());
									...
									<tr valign="bottom"><td align="center">
										<img src="images/index/080922fuwunian2.jpg" border="0" width="150" /></td></tr>
