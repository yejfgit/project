...
<div class=bank5></div>
<p><a href="list.jsp?id=4065" target="_blank"><img src="images/gandong.jpg" border="0" /></a>
</p>
<div class=bank5></div>
...
<!--yjkb-->
<p><img src="images/l1.jpg" width="259" height="10" /></p>
<div class="Lcon" style="height:170px;">
...
<div id="link4" style="position: absolute; width: 230px; display: none;filter: Alpha(Opacity=80);">
<p><img src="images/xt09.jpg" /></p>
<div id="xt2"  class="xt">
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="2" pageSize="11" conditions="isDelete=0:i;isProcessing=0:i;" />
...
<img src="images/gdhz-01.jpg" onclick="window.open('https://cs.unionlife.com.cn/HZTP/main.jsp')" title="点击进行投票" style="cursor:hand" />
<center><a href="javascript:void(0)" onclick="closeDl()">关闭</a></center><!--  -->
</div>
<div id="dl2" style="z-index: 100; top:-1000px; right:10px; width: 80px; height:300px; position: absolute;background-color: #FFFFFF">
<img src="images/gdhz-02.jpg" onclick="window.open('https://cs.unionlife.com.cn/HZTP/main.jsp')" title="点击进行投票" style="cursor:hand" />
 <center><a href="javascript:void(0)" onclick="closeDl()">关闭</a></center><!-- -->
</div> 
