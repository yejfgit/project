function cList(cid, cName){
	if(window.confirm("您确定要更改此栏目的位置吗？")){
		document.getElementById("idparentColumn").value = cid;
		document.getElementById("idparentName").innerHTML = cName;
	}
}
...
function toAddColumn(){
	tableId = "idcolumn";
	send_request("admin/add/addcolumn.jsp");
}
