        	...
        	var top = $("#bottom").offset().top;  
          	if(!loaded && $(window).scrollTop() + $(window).height() > top ){  
            	...
            	if(index==2){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="2" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% int index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
								var showDiv = "<div style='width: 100%;height: 116px;border-bottom: 1px solid #ddd;margin-top: 8px;'>"+
											  "		<div style='height: 100%;width: 150px;background-color: #fff;float: left;cursor: pointer;' onclick='openInfo(<bean:write name='element' property='contentId' />)'>"+
            	...
            	if(index==3){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="3" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
            	...
            	if(index==4){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="4" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
            	...
            	if(index==5){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="5" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
            	...
            	if(index==6){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="6" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
            	...
            	if(index==7){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="7" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
            	...
            	if(index==8){
	            	...
	            	<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="8" pageSize="10" columnId="5686" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
					<% index111=1;%>
					<logic:iterate id="element" name="cl" property="objectList">
						<logic:notEmpty name="element" property="attachmentList">
							<logic:iterate id="e" name="element" property="attachmentList">
	...
	<div class="mainDiv">
		...
		<div class="mainLeft">
			<div class="left">
				...
				<div id="comments"></div>  
				<div id="bottom" style="text-align: center;cursor: pointer;line-height: 50px;color: #ccc;vertical-align: center;height: 50px;">加载更多......</div>  
			</div>
			<div class="right">
