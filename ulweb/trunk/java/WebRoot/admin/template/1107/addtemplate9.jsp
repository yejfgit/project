...
{   
 ...
 function save(){
  ...
  %>
  <body>
   <table width="770" cellpadding="0" align="center" cellspacing="0" border="0">
		...
		<tr>
			<td>
				<table width="100%" align="center">
					...
					首页背景
					<img src="" border="0" id="imgpic1" onClick="javascript:openwin('uploadpic.jsp?name=pic1','pic');"/></td></tr>
					<tr>
					...
					<tr>
						...
						<td align="left" valign="top">
							<table cellpadding="0"  align="center" cellspacing="0" border="0" width="95%">
								...
								<tr>
									<td width="30"></td>
									<td rowspan="2" width="50" ><img src="" border="0" id="imgpic3" onClick="javascript:openwin('uploadpic.jsp?name=pic3','pic');"/>
												</td>
									<td></td>
								</tr>
								<tr>
									<td width="10"><img src="" alt="背景小图" border="0" id="imgpic4" onClick="javascript:openwin('uploadpic.jsp?name=pic4','pic');"/>
												</td>
