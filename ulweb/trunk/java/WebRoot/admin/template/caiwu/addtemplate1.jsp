...
{   
  ...
  <body>
   <table width="750" cellpadding="0" align="center" cellspacing="0" border="0">
	...
	<input type="hidden" name="dept" value="caiwu"/>
					...
					<tr><td width="100%" colspan="4">
						<table width="100%">
							...
							<tr><td  align="center">题头图片<br>
								<img src="" border="0" id="imgpic2" onClick="javascript:openwin('uploadpic.jsp?name=pic2','pic');"/></td>
							</tr>
							<tr><td>内容列表背景图片<br>
								<img src="" border="0" id="imgpic3" onClick="javascript:openwin('uploadpic.jsp?name=pic3','pic');"/></td>
							</tr>
						</table>
						</td>
					</tr>					
