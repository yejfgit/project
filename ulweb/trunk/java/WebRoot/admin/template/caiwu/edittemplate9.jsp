		...
		<tr>
			<td>
				<table width="100%" align="center">
					...
					<tr>
						...
						<td colspan="4">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tr><td align="center">	<img src="<%=t.getPic6()%>" border="0" title="通讯录:这里会显示一个小红叉，这是正常的" id="imgpic6" onClick="javascript:openwin('uploadpic.jsp?name=pic6','pic');"/>
									</td>
								</tr>
								<tr>
									<td align="center">									
								...
								<tr>
									<td align="center">										
										<img src="<%=t.getPic2()%>" border="0" title="最上边的图片" id="imgpic2" onClick="javascript:openwin('uploadpic.jsp?name=pic2','pic');"/>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr><td colspan="4">
						<table width="100%">
							<tr><td valign="bottom" width="30%" align="center" style="border-left:1px gray solid;">
									<img src="<%=t.getPic3()%>" border="0" id="imgpic3" onClick="javascript:openwin('uploadpic.jsp?name=pic3','pic');" title="左侧下方图片，适宜高度70，适宜宽度184"/><br><br><br>
								</td>
								<td height="300" valign="top">
									<table width="100%">
										<tr>
											<td height="180" width="250" align="center" style="border:1px gray solid;">
								<img src="<%=t.getPic5()%>" border="0" id="imgpic5" title="新闻图片:适宜高度105，适宜宽度140" onClick="javascript:openwin('uploadpic.jsp?name=pic5','pic');"/>											
											</td>
										...
										<tr>
											...
											<td style="border-right:1px gray solid;">
												<img src="<%=t.getPic4()%>" border="0" id="imgpic4" title="适宜高度80，适宜宽度300左右" onClick="javascript:openwin('uploadpic.jsp?name=pic4','pic');"/>			
											</td>
										</tr>
