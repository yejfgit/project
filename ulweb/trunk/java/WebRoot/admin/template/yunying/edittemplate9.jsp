...
{   
 ...
 <table width="750" cellpadding="0" align="center" cellspacing="0" border="0">
	...
	<input type="hidden" name="dept" value="yunying"/>	
					...
					<tr>
						<td colspan="4">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">	
								<tr>
									<td align="center">列车时刻表<br>
										<img src="<%=t.getFlash()%>" border="0"  id="imgflash" onClick="javascript:openwin('uploadpic.jsp?name=idflash','flash');"/>
									</td>
								</tr>							
								<tr>
									<td align="center">	首页显示图片（自动变换）<br>						
