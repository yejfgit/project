					...
					<tr>
						<td>
							...
							<table width="100%">
								<%
									String[] used = {"已启用","已禁用"};
									String[] color = {"color:green","color:red"};									
								...
								<tr>
									...
									<td>	
										 <a  href="admin/template.do?method=delete&templateId=<%=list.get(i).getTemplateId()%>&d=<%=(list.get(i).getIsDelete() == 1 ? 0 : 1)%>" style="<%=color[list.get(i).getIsDelete()]%>"><%=used[list.get(i).getIsDelete()]%></a>
