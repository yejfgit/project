...
<table width="550" border="1" align="center" cellpadding="0" cellspacing="0">
	<form action='admin/document.do?method=addAttachment' method="post" name="form1" enctype="multipart/form-data">
	<input type="hidden" name="columnId" value='<%=request.getParameter("columnId")%>' />
