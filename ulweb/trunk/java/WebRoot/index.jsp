...
<script type="text/javascript">
	$(function(){
		...
		var scrollTime = 500;
		var changeTime = 3000;
		var size=$("#scrollwrr ul li").size()-1;
		var isAnimate = false;
		function move(index){
			if(index<size){
				$("#scrollwrr ul li:eq("+index+")").animate({
		...
		function scrollUp(){
			$("#scrollwrr").animate({
				...
				$("#scrollwrr ul li").removeAttr("style");
				clearInterval(T);
				isAnimate = false;
			});
		}
...
<style type="text/css">
	*{ margin:0; padding:0; list-style:none;}
	.scrollwrr_con{width:1005px; position:relative;}
	#scrollwrr{ width:980px; overflow:hidden; height:0px;}
	#scrollwrr ul{ font-size:0px; width:1000000000px;}
	#scrollwrr ul li{ float:left;}
	.replay_xl{ width:10px; height:30px; cursor:pointer; font-size:12px; position:absolute; left:990px;}
</style>

</head>

<body>
<!--<body style="margin:0px;" onload="loadImage('images/newtenFlash.jpg',imgLoaded);">-->
<DIV class=BOX>

<!-- <div id="myDiv" style="display:none; overflow:hidden;z-index: 200" onclick="hideImage()" onmouseover="this.style.cursor='hand'; "><img src="images/newtenFlash.jpg" id="myImgs" alt="点击关闭图片" /> </div> -->
<div id="myDiv" style="display:none; overflow:hidden;z-index: 200"  onmouseover="this.style.cursor='hand'; "><a href="guost/index.html" target="_Blank"><img src="images/newtenFlash.jpg" id="myImgs" /></a> </div> 
<jsp:include flush="true" page="headzhn.jsp"></jsp:include>
<!-- ccrc 
<div class="scrollwrr_con">
	<div id="replay" class="replay_xl"  onclick=""><img src="images/ccrc/xl_cb.jpg" /></div>
	<div id="scrollwrr">
		<ul>
			<li>
				<img width="980" height="500" src="images/ccrc/lx_1.jpg" />
			</li>
			<li>
				<img width="980" height="500" src="images/ccrc/lx_2.jpg" />
			</li>
			<li>
				<img width="980" height="500" src="images/ccrc/lx_3.jpg" />
			</li>
			<li>
				<img width="980" height="500" src="images/ccrc/lx_4.jpg" />
			</li>
			<li>
				<img width="980" height="500" src="images/ccrc/lx_5.jpg" />
			</li>
		</ul>
	</div>
</div>-->
...
<div class=bank5></div>
<p><a href="guost/index.html" target="_blank"><img src="images/newten.jpg" border="0" /></a>
</p>
<div class=bank5></div>
<p><a href="list.jsp?id=4864" target="_blank"><img src="images/zhibei2.jpg" border="0" /></a>
</p>
<div class=bank5></div>
...
<!--yjkb-->
<p><img src="images/l1.jpg" width="259" height="10" /></p>
<div class="Lcon" style="height:185px;">
<p><span class="fri"><a href="list.jsp?id=2684" target="_blank"><img src="images/more.jpg" /></a></span><img src="images/yj.jpg" /></p>
<div  class=bank5></div>
<ul>
<ulweb:content beanName="cl" deptId="qihua" enName="yeji" pageNum="1" pageSize="6" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
...
<ul>
<ulweb:content beanName="cl" deptId="market" enName="subao" pageNum="1" pageSize="6" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li><div class="break" style="width: 220px">·<bean:write name="element" property="contentNameLink" filter="false" /></div></li>
		</logic:iterate>
</ul>
...
<ul>
<ulweb:content beanName="cl" deptId="baofei" enName="bobao" pageNum="1" pageSize="6" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li><div class="break" style="width: 220px">·<bean:write name="element" property="contentNameLink" filter="false" /></div></li>
		</logic:iterate>
</ul>
...
<ul>
<ulweb:content beanName="cl" deptId="1110" enName="bobao" pageNum="1" pageSize="6" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li><div class="break" style="width: 220px">·<bean:write name="element" property="contentNameLink" filter="false" /></div></li>
		</logic:iterate>
</ul>
...
<!--zt-->
	...
	<p><img src="images/l1.jpg" width="259" height="10" /></p>
	<div id="topic1" class="Lcon" style="height: 162px;">
		<p><span class="fri"><img src="images/more.jpg" /></span><img src="images/m2.jpg" /></p>
		<div class=bank5></div>
		<ulweb:content beanName="cl" deptId="0000" enName="topic" pageNum="1" pageSize="3" conditions="isDelete=0:i;isProcessing=0:i;" />
			<logic:iterate id="element" name="cl" property="objectList">
...
<ulweb:content beanName="cl" deptId="0000" enName="bobao" pageNum="1" pageSize="4" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
<li><span class="fri"><bean:write name="element" property="updateTime" format="yyyy-MM-dd" /></span>·<a href="show.do?c=<bean:write name="element" property="contentId" />" target="_blank" title="<bean:write name="element" property="contentName" />" <logic:equal name="element" property="displayType" value="9">style="color:#ff0000"</logic:equal> ><script>document.writeln("<bean:write name="element" property="contentName" />".substring(0,28));</script></a></li>
		</logic:iterate>
</ul>
...
<p><!-- newsAd Begin -->
<script language="javascript">
var imgUrlWeihua=new Array();
var imgLinkWeihua=new Array();
var textWeihua=new Array();
var adNumWeihua=0;
var buttonShowWeihua=1;
var buttonPosWeihua=2; //RU:1，RD:2，LU:3，LD:4



<ulweb:content beanName="cl" deptId="0000" enName="nwWeihuaTupian" pageNum="1" pageSize="10" conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
<% int index2=1; %>
<logic:iterate id="element" name="cl" property="objectList">

	<logic:notEmpty name="element" property="attachmentList">
		<logic:iterate id="e" name="element" property="attachmentList">
imgUrlWeihua[<%=index2%>]="<bean:write name="e" property="displayPath" filter="false" />";
imgLinkWeihua[<%=index2%>]="<bean:write name="element" property="subTitle" filter="false" />";
textWeihua[<%=index2%>]="<bean:write name="element" property="keyWord" filter="false" />";			
<% index2++; %>
		</logic:iterate>
	</logic:notEmpty>
</logic:iterate>
								...
								<script language="javascript" src="js/newsAdWeihua.js"></script>
								<table id=newsTableWeihua border="0" cellspacing="0" cellpadding="0" style="border: solid 1px #CCCCCC; ">
									<script language="javascript">dakularButtonsWeihua();</script>
									<tr>
										<td>
											<a
												onMouseOver="displayStatusMsgWeihua();return document.returnValue"
												onMouseOut="status='';" class=px14-lh24
												href="javascript:jump2urlWeihua()"><img
													style="FILTER: revealTrans(duration=1,transition=10); border:0px solid #000000"
													src="#" width=470 height=150 border=0
													name=imgUrl1rotatorWeihua alt="" /> </a><script>nextAdWeihua();</script>
										</td>
									</tr>
								</table>
								<!-- newsAd End -->
...
<div class="Hcon" style="height: 265px">
<ul class="H24">
...
//alert(document.body.clientWidth);
	...
	document.getElementById("link3").style.left = document.body.clientWidth / 2 + 32-226 + 'px';
...
<p><img src="images/xt_1.bmp" /></p>
<div id="link1" class="xt" style="height: 565px;display: block">
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="1" pageSize="18" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
...
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="2" pageSize="18" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li>·<a href="<bean:write name="element" property="subTitle" />" target="_blank"><bean:write name="element" property="contentName" /></a></li>
		</logic:iterate>
</ul>
...
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="3" pageSize="18" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li>·<a href="<bean:write name="element" property="subTitle" />" target="_blank"><bean:write name="element" property="contentName" /></a></li>
		</logic:iterate>
</ul>
...
<!-- 系统链接 
<div id="link4" class="xt" style="display:none;height: 340px" >
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="link" pageNum="4" pageSize="11" conditions="isDelete=0:i;isProcessing=0:i;" />
 ...
 -->
<div  style="display:inline;position:absolute; top:599px; left:111px;">
...
<tr align="center">
<td ><!-- <img src="images/new3.gif" /> --></td>
<td style="height:12px;">
<div>
<div id='lbt1' class="lbt" 	style="background-color:#4DAC26;color:#FFFFFF;" onmouseover="changelbtColor(this);tagSelect1('link', 1, 4)" >&nbsp;1&nbsp;</div>
<div id='lbt2' class="lbt" onmouseover="changelbtColor(this);tagSelect1('link', 2, 4)" >&nbsp;2&nbsp;</div>
<div id='lbt3' class="lbt" onmouseover="changelbtColor(this);tagSelect1('link', 3, 4)" >&nbsp;3&nbsp;</div>
<!-- <div id='lbt4' class="lbt" onmouseover="changelbtColor(this);tagSelect1('link', 4, 4)"  >&nbsp;4&nbsp;</div> -->
</div>
</td>
</tr>
</table>
</div>
<p><img src="images/xt2_1.JPG" /></p>
</div>
<div class=bank5></div>


<!--xz-->
<!--<div class="za" style="height: 225px">
<p>
table cellpadding="0" cellspacing="0" border="0"><tr>
 <td><a href="pinxuan.do?method=subPage&cName=newspaper&columnId=726" target="_blank"><img id="tag_mgz1" src="images/baozhi_1.jpg" class="tagSel" onmouseover="tagSelect('mgz', 1, 2)" /></a></td>
...
<td><img src="images/baozhi_1.jpg" /><a href="list.jsp?id=3964" target="_blank"><img src="images/mor.jpg" width="50" height="28" /></a></td>
...
<div style="overflow: hidden;margin-top: 5px;">
	<div style="width: 107px;height: 28px;background: url('weihua/images/weihua1.jpg');float: left;margin-left: 5px;" ></div>
	<div style="width: 65px;height: 28px;background: url('weihua/images/weihua2.jpg');float: left;"></div>
	<div style="width: 45px;height: 28px;background: url('weihua/images/weihua3.jpg');float: left;cursor: pointer;" onclick="window.open('weihua.do?method=index');"></div>
</div>

<ul>
<ulweb:content beanName="c2" deptId="0000" enName="weihua" pageNum="1" pageSize="1"  conditions="isDelete=0:i;isProcessing=0:i;" withAtt="1" />
<logic:iterate id="element" name="c2" property="objectList">
	<% int imgIndexF = 1; %>
	<logic:notEmpty name="element" property="attachmentList">
		<logic:iterate id="e" name="element" property="attachmentList">
			<% if(imgIndexF==1){%>
			<div style="width: 100%;height: 60px;overflow: hidden;margin-top: 0px;border: 0px solid blue;margin-bottom: 15px;">
				<div style="height: 60px;width: 60px;background-color: #fff;float: left;" >
					<img src="<bean:write name="e" property="displayPath" />" style="width: 60px;height: 60px" class="bor"/>
				</div>
				<div style="height: 100%;width: 120px;;float: left;text-align: left;">
					<div style="font-size: 12px;font-weight:bolder;cursor: pointer;">
						<a target="_black" style="text-decoration: none;cursor: pointer;" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
							<div style="width: 135px;line-height: 15px;height: 30px;overflow: hidden;margin: 3px 10px;">
								<bean:write name="element" property="contentName" filter="false" />
							</div>
						</a>
						<a target="_black" style="margin-left: 10px;;text-decoration: none;color: #840B1A" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
							[详细]
						</a>
					</div>
				</div>
...
<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="2" pageSize="1" conditions="isDelete=0:i;isProcessing=0:i;" />
<logic:iterate id="element" name="cl" property="objectList">
	<li>
		<div class="break" style="width: 200px">
			·<a target="_black" style="text-decoration: none" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
				<bean:write name="element" property="contentName" filter="false" />
			</a>
		</div>
	</li>
</logic:iterate>
<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="3" pageSize="1" conditions="isDelete=0:i;isProcessing=0:i;" />
<logic:iterate id="element" name="cl" property="objectList">
	<li>
		<div class="break" style="width: 200px">
			·<a target="_black" style="text-decoration: none" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
...
<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="4" pageSize="1" conditions="isDelete=0:i;isProcessing=0:i;" />
<logic:iterate id="element" name="cl" property="objectList">
	<li>
		<div class="break" style="width: 200px">
			·<a target="_black" style="text-decoration: none" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
...
<ulweb:content beanName="cl" deptId="0000" enName="weihua" pageNum="5" pageSize="1" conditions="isDelete=0:i;isProcessing=0:i;" />
<logic:iterate id="element" name="cl" property="objectList">
	<li>
		<div class="break" style="width: 200px">
			·<a target="_black" style="text-decoration: none" href="weihua.do?method=show&c=<bean:write name="element" property="contentId" />">
...
<!-- 
<div class="za" style="height: 225px">
<p><img src="images/dzbz2.jpg" /><a href="list.do?method=zongbuHaveAtt&ptype=videoslianghui&columnId=3964" target="_blank"><img src="images/mor.jpg" width="50" height="28"/></a></p>
<ul>
<ulweb:content beanName="cl" deptId="0000" enName="history" pageNum="1" pageSize="7" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList">
			<li><div class="break" style="width: 200px">·<a href="<bean:write name="element" property="subTitle" />" target="_blank" title="<bean:write name="element" property="contentName" />"><bean:write name="element" property="contentName" /></a></div></li>
		</logic:iterate>
</ul>
</div>
 -->
										...
										<td><img src="images/gongyi1.jpg" /><a href="list.jsp?id=3524" target="_blank"><img src="images/mor.jpg" width="50" height="28" /></a>
											<a
												...
												href="javascript:jump2url1()"><img
													style="FILTER: revealTrans(duration=1,transition=23); border:0px solid #000000"
													src="#" width=224 height=136 border=0
													name=imgUrl1rotator alt=""> </a> <script>nextAd1();</script>
										</td>
									</tr>
								</table>
								<!-- newsAd End -->
<!--xz-->
<div class="za" style="height: 215px">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="80" align="left" valign="top"><img src="images/k1.jpg"  /><!-- <a href="http://it/service/itshare" target="_blank"><img src="images/k1.jpg"  /></a> --></td>
    <td align="center" valign="top"><a href="market.do?method=subPage2&columnId=169" target="_blank"><img src="images/k2.jpg" alt=""  /></a></td>
    <td align="center" valign="top"><img src="images/k3_1.jpg" alt=""  /></td>
  
    <td align="center" valign="top"><img src="images/k4.jpg" alt=""  /></a></td>
    <td align="center" valign="top"><img src="images/k5.jpg" alt="" /></a></td>
...
<div id="Float21789" style="z-index: 1000; top:-1000px; left:-1000px; width: 400px; height:300px; position: absolute; border: solid 1px #000000; background-color: #FFFFFF">
	<center>
		<table width="100%"><tr>
<td align="left">s<strong><bean:write name="element" property="keyWord" /></strong></td>
...
<!--
<div id="dl1" style="z-index: 100; top:-1000px; left:10px; width: 80px; height:300px; position: absolute;background-color: #FFFFFF">
<img src="images/result_left.jpg" onclick="window.open('http://ulweb/newapp/show.do?c=119244')" title="点击进行投票" style="cursor:hand" />
<center><a href="javascript:void(0)" onclick="closeDl()">关闭</a></center>  
</div>-->
<!--<div id="dl2" style="z-index: 100; top:-1000px; right:10px; width: 100px; height:100px; position: absolute;background-color: #FFFFFF">
<center>合众人寿官方微信</center> 
<img src="images/unlife.jpg"  title="扫一扫" style="cursor:hand;width: 100px; height:100px;" />
 <center><a href="javascript:void(0)" onclick="closeDl()">关闭</a></center> 
</div>-->
...
//document.getElementById("dl2").style.top=csdnScrollTop() + 600  +'px';
