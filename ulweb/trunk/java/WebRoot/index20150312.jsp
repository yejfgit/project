...
<logic:iterate id="element" name="cl" property="objectList">
	...
	<logic:notEmpty name="element" property="attachmentList">
		<logic:iterate id="e" name="element" property="attachmentList">
imgUrl[<%=index2%>]="<bean:write name="e" property="displayPath" filter="false" />";
imgLink[<%=index2%>]="<bean:write name="element" property="subTitle" filter="false" />";
text[<%=index2%>]="<bean:write name="element" property="keyWord" filter="false" />";			
<% index2++; %>
		</logic:iterate>
	</logic:notEmpty>
</logic:iterate>
