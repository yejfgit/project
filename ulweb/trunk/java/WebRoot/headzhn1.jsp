...
<ulweb:content beanName="cl" deptId="0000" enName="service_promise" pageNum="1" pageSize="1" conditions="isDelete=0:i;isProcessing=0:i;" />
		<logic:iterate id="element" name="cl" property="objectList"><a href='<bean:write name="element" property="subTitle" />' target="_blank"><img src="images/service_promise_new.gif" /></a></logic:iterate>
</td>
...
<area shape="rect" coords="106,0,182,22" href="http://it/service/default.aspx" target="_blank" />
