...
<table align="center">
<tr>
<td align="center">问卷名称：<input type="text" id="surveyName" name="surveyName" />&nbsp;&nbsp;
时间限制：<input type="text" id="timeLimit" name="timeLimit" size="5" value="0" />分钟（0为不限）&nbsp;&nbsp;
<input type="checkbox" id="isShuffle" name="isShuffle" />随机题目顺序<br />
