...
function addQue() {
	...
	var queDivHtml = '<div id="queDiv' + queCount + '"><br>&nbsp;&nbsp;&nbsp;&nbsp;题目' + queCount + '：<input type="text"  style="width:400px" id="queName' + queCount + '" />&nbsp;&nbsp;<input type="checkbox" onclick="choose('+queCount+')" id="queType' + queCount + '"/>不定项&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="增加选项" onclick="addOpt(' + queCount + ')" />&nbsp;<input type="button" value="X" onclick="delQue(' + queCount + ')" /></div>'+
		...
		<div id="div2" style="width:100%;">
			<table align="left" width="100%" style="background-color: white;margin-top: 15px;">
				...
				<tr>
					...
					<button type="button" id="a" onclick="doSubmit()" class="btn" onmouseover="overChangeBtn(this)" onmouseout="outChangeBtn(this)"><img src="images/newImages/survey_img/save.bmp" width="16" height="16" style="vertical-align:middle" /> 创建问卷</button>
					&nbsp;
...
<table align="center" width="80%" height="24"  border="0" cellpadding="0" cellspacing="0">
  <tr>
  	<td height="30px" style="color:#0e9cdf;font-size:14px;vertical-align:bottom;"><a href="survey.do?method=WJList&type=2" style="color:#0e9cdf;" target="mainFrame">首页</a> >> <strong>复制调查问卷</strong></td>
  </tr>
