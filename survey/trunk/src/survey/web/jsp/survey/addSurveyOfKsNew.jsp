...
<table align="center" width="80%" height="24"  border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #ddd;" class="titBar2">
  <tr>
  		<td height="30px" class="titBar3">
  		<a href="survey.do?method=WJList&type=1"  target="mainFrame">返回首页</a> 
  		</td>
...
<div style="width:80%;margin: 0 auto;">
	<div style="width: 20%;float: left;position: fixed; margin: 0;">
		<div style="width: 75%;height: 160px;border: solid 1px #DDDEE3;">
			...
			<div class="setC">
				催办次数：<input type="text" id="hurryTimes" name="hurryTimes" value="0" size="1"> 
			</div>
			<div class="setC" >
				时间限制（0为不限）<input type="text" id="timeLimit" name="timeLimit" size="3" value="0" />分钟
			</div>
		</div>
