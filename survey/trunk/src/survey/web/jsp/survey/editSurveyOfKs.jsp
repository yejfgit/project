...
if (!confirm('卷面总分为 '+surveyScore+'分  您确定修改此问卷吗？')) {
		return false;
	}
	...
	document.f1.action = 'survey.do?method=update&surveyId='+sid;
	document.f1.submit();
...
<div style="width:80%;margin: 0 auto;">
	...
	<div style="width: 80%;float: right">
		<div style="background-color: white;">
			<div class="setC3">
				<strong>问卷名称：</strong><input type="text" style="width:300px;font-size: 14px;" id="surveyName" name="surveyName" value="<bean:write name="survey" property="name" />" />
...
<tr><td style="width:100%;text-align:center;height:30px;"><button type="button" id="a" onclick="addFgx()" style=" vertical-align:middle;background-color: white;"><img src="images/newImages/survey_img/fengexian.gif" width="16" height="16" style="vertical-align:middle" /> 分割线</button>
</td></tr>
