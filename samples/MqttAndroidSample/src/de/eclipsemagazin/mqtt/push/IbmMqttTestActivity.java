 ...
 *
 */
public class IbmMqttTestActivity extends Activity {

    public static final String SERVICE_CLASSNAME = "de.eclipsemagazin.mqtt.push.IbmMqttService";
    ...
    private void startBlackIceService() {
        ...
        //final Intent intent = new Intent(this, IbmMqttService.class);
       
        IbmMqttService  service = new IbmMqttService();
        service.actionStart(this);
