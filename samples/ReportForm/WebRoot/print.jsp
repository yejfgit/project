...
<%@ page import="dy.javabean.WebappDataSource" %>
<%
...
function excel(){
	window.location.href="<%=path%>/excelServlet";
}
...
<body>
<br>
<form name="excelform" action="excelServlet" method="post">
			
			起始页：
			<input name="pageFrom" id="pageFrom" type="text" />
			结束页：
			<input name="pageTo" id="pageTo" type="text" />
...
<%
	...
	//parameters.put("pageFrom", 1);
	//parameters.put("pageTo", 5);
