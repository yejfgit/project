...
public class DataSourceApp extends AbstractSampleApp
{
	...
	public void fill4() throws JRException
	{
		...
		JasperFillManager.fillReportToFile("build/reports/DataSourceReport.jasper", parameters, new JRBeanCollectionDataSource(CustomBeanFactory.createBeanCollection()));
		System.err.println("Filling time : " + (System.currentTimeMillis() - start));
	}
